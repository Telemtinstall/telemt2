...
# Telemt installer for a fresh Astra Linux server, without WireGuard.
...
you can override this guard:
  ALLOW_NO_ROOT_KEY=1 bash install_telemt_astra.sh
EOF
  exit 1
fi
...
step "Done"
cat <<EOF
Installed Telemt on Astra Linux without WireGuard.
